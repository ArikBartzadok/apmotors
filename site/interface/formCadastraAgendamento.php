...
<body>
    ...
    <div class="row">
            ...
            <center><h3 class="display-4">CADASTRAR AGENDAMENTO</h3></center>
				<form action="../controlador/cadastraAgendamento.php" method="POST">
                    ...
                    <a href="http://localhost/apmotors/site/home.php" class="btn btn-danger" value="VOLTAR" name="btn_entrar" style='border-radius: 20px;'>VOLTAR</a>
				</form>
			</div>
		</div>
	</div>
